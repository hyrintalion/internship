...
$config['db_name'] = 'arazumova_cscart';
$config['db_user'] = 'arazumova';
$config['db_password'] = 'Fg2JO50GRnIq2AHx';
...
$config['http_host'] = 'arazumova.simtechdev.net';
$config['http_path'] = '/cs-cart';

// Host and directory where software is installed on secure server
$config['https_host'] = 'arazumova.simtechdev.net';
